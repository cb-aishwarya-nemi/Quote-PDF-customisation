      ...
      <div ref={rootRef} className={`relative flex min-w-0 ${className ?? ""}`}>
        ...
        {open && (
          <div
            ...
            className="absolute right-0 top-[calc(100%+6px)] z-40 w-64 overflow-hidden rounded-xl border border-gray-200 bg-white py-1 shadow-lg"
          >
